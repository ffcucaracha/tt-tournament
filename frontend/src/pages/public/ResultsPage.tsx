    ...
    <div className="space-y-4">
      ...
      <details className="rounded-md border border-white/10 bg-panel/90 px-4 py-3 text-sm text-textMuted">
        ...
        <div className="mt-2 space-y-1 text-xs leading-5">
          ...
          <p>4. Если результат всё равно равный, игроки делят места: например 5-6 или 5-6-7.</p>
          <p>Баллы — отдельный зачёт для рейтинга трайбов: при равных местах берётся среднее за эти места.</p>
        </div>
      </details>
